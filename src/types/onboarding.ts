...
export const DEFAULT_DOCUMENTS: DocumentUploadItem[] = [
  ...
  },
  {
    ...
    fileName: null,
    referenceLink: '/templates/system-prompt-template.csv',
    isRecommendedTemplate: false,
  },
  {
    id: 'agent-tool-prompt',
    label: 'Agent and Tool Prompt',
    description: '.json format only, should be as reference format',
    acceptedFormats: ['.json'],
    acceptExtensions: '.json',
    fileName: null,
    referenceLink: '/templates/agent-tool-prompt-template.json',
    isRecommendedTemplate: false,
  },
];
